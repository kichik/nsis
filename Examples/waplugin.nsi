...
!if ${NSIS_PTR_SIZE} = 8
  File /oname=vis_nsfs.dll "${NSISDIR}\Plugins\amd64-unicode\TypeLib.dll" # dummy plug-in
!else
  File /oname=vis_nsfs.dll "${NSISDIR}\Plugins\x86-unicode\TypeLib.dll" # dummy plug-in
!endif

...
void __declspec(dllexport) Init(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
...
void __declspec(dllexport) Show(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop)
{
...
void __declspec(dllexport) Select(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{

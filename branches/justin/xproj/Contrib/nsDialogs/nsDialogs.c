...
void __declspec(dllexport) Create(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
...
void __declspec(dllexport) CreateControl(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  char *className;
  char *text;
...
void __declspec(dllexport) CreateItem(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  CreateControl(hwndParent, string_size, variables, stacktop, extra);
}

void __declspec(dllexport) SetUserData(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  HWND hwCtl;
...
void __declspec(dllexport) GetUserData(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  HWND hwCtl;
  struct nsControl* ctl;
...
void __declspec(dllexport) CreateTimer(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  UINT callback;
  UINT interval;
...
void nsdKillTimer(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  UINT id;
...
void __declspec(dllexport) OnClick(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  SetControlCallback(CTL_CALLBACK_IDX(onClick));
}

void __declspec(dllexport) OnChange(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  SetControlCallback(CTL_CALLBACK_IDX(onChange));
}

void __declspec(dllexport) OnNotify(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  SetControlCallback(CTL_CALLBACK_IDX(onNotify));
}

void __declspec(dllexport) OnBack(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  SetDialogCallback(DLG_CALLBACK_IDX(onBack));
}

void __declspec(dllexport) Show(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{

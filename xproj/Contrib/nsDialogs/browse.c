...
void __declspec(dllexport) SelectFolderDialog(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{
  BROWSEINFO bi;
...
void __declspec(dllexport) SelectFileDialog(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop, extra_parameters *extra)
{

...
void __declspec(dllexport) Exec(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop) {
...
void __declspec(dllexport) ExecToLog(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop) {
  g_hwndParent=hwndParent;
  EXDLL_INIT();
  {
    ExecScript(1);
...
void __declspec(dllexport) ExecToStack(HWND hwndParent, int string_size, char *variables, nsis_stack_t **stacktop) {
  g_hwndParent=hwndParent;
  EXDLL_INIT();
  {
    ExecScript(2);

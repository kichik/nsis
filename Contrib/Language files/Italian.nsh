...
!ifdef MUI_LICENSEPAGE
  ...
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM "Per installare $(^NameDA) è necessario accettare i termini dell'accordo di licenza.$\r$\nSe accetti tutti i termini dell'accordo di licenza, seleziona 'Accetto' per continuare."
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Per installare $(^NameDA) è necessario accettare i termini dell'accordo di licenza.$\r$\nSe accetti i termini dell'accordo di licenza, seleziona la casella sottostante.  $_CLICK"
  ${LangFileString} MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Per installare $(^NameDA) è necessario accettare i termini della licenza d'uso.$\r$\nSe accetti i termini dell'accordo di licenza, seleziona la prima opzione sottostante.  $_CLICK"
!endif
...
!ifdef MUI_UNLICENSEPAGE
  ...
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM "Per installare $(^NameDA) è necessario accettare i termini dell'accordo di licenza.$\r$\nSe accetti tutti i termini dell'accordo di licenza, seleziona 'Accetto' per continuare."
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Per installare $(^NameDA) è necessario accettare i termini dell'accordo di licenza.$\r$\nSe accetti i termini dell'accordo di licenza, seleziona la casella sottostante. $_CLICK"
  ${LangFileString} MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Per installare $(^NameDA) è necessario accettare i termini della licenza d'uso.$\r$\nSe accetti i termini dell'accordo di licenza, seleziona la prima opzione sottostante. $_CLICK"
!endif
...
!ifdef MUI_FINISHPAGE
  ...
  ${LangFileString} MUI_TEXT_FINISH_INFO_REBOOT "Per completare l'installazione di $(^NameDA) il computer deve essere riavviato.$\r$\n$\r$\nVuoi riavviarlo ora?"
!endif
...
!ifdef MUI_UNFINISHPAGE
  ...
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_REBOOT "Per completare la disinstallazione di $(^NameDA) il computer deve essere riavviato.$\r$\n$\r$\nVuoi riavviarlo ora?"
!endif
...
!ifdef MUI_FINISHPAGE | MUI_UNFINISHPAGE
  ...
  ${LangFileString} MUI_TEXT_FINISH_SHOWREADME "Visualizza il file Leggimi"
...
!ifdef MUI_STARTMENUPAGE
  ...
  ${LangFileString} MUI_INNERTEXT_STARTMENU_TOP "Seleziona la cartella del menu Start in cui verranno creati i collegamenti del programma.$\r$\nÈ possibile inserire un nome per creare una nuova cartella."
...
!ifdef MULTIUSER_INSTALLMODEPAGE
  ...
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_CURRENTUSER "Installazione per l'utente attuale"
!endif

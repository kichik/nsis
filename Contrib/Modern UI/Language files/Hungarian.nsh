...
!insertmacro MUI_LANGUAGEFILE_BEGIN "HUNGARIAN"
  ...
  !define MUI_INNERTEXT_LICENSE_BOTTOM "Ha elfogadja a szerzõdés valamennyi feltételét, az Elfogadom gombbal folytathatja. El kell fogadnia a(z) $(^Name) telepítéséhez."
  !define MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Amennyiben elfogadja a feltételeket, jelölje be a jelölõnényzeten. A(z) $(^Name) telepítéséhez el kell fogadnia a feltételeket. $_CLICK"
  !define MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Amennyiben elfogadja a feltételeket, válassza az elsõ opciót. A(z) $(^Name) telepítéséhez el kell fogadnia a feltételeket. $_CLICK"
  ...
  !define MUI_UNTEXT_LICENSE_SUBTITLE "A(z) $(^Name) eltávolítása elõtt tekintse át a szerzõdés feltételeit."
  !define MUI_UNINNERTEXT_LICENSE_BOTTOM "Ha elfogadja a szerzõdés valamennyi feltételét, az Elfogadom gombbal folytathatja. El kell fogadnia a(z) $(^Name) eltávolításához."
  !define MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Amennyiben elfogadja a feltételeket, jelölje be a jelölõnényzeten. A(z) $(^Name) eltávolításához el kell fogadnia a feltételeket. $_CLICK"
  !define MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Amennyiben elfogadja a feltételeket, válassza az elsõ opciót. A(z) $(^Name) eltávolításához el kell fogadnia a feltételeket. $_CLICK"

...
!insertmacro MUI_LANGUAGEFILE_BEGIN "KOREA"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_LANGNAME "한글" ;Name of the language in the language itself
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_WELCOME_INFO "이 마법사는 당신의 컴퓨터에 ${MUI_PRODUCT}을(를) 설치할 것입니다.\r\n\r\n설치를 시작하기 전에 모든 프로그램을 종료해주시기 바랍니다. 프로그램을 종료하게 되면 시스템을 재부팅 하지 않고서도 특정한 시스템 파일을 수정할 수 있기 때문입니다.\r\n\r\n"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_ABORTWARNING "${MUI_PRODUCT} 설치를 종료 하시겠습니까?"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNINNERTEXT_INTRO "시스템에서 ${MUI_PRODUCT}을(를) 삭제 할 것입니다."

  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_UNINSTALLING_TITLE "삭제중"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_UNINSTALLING_SUBTITLE "${MUI_PRODUCT}을(를) 삭제하는 동안 잠시 기다려 주시기 바랍니다."

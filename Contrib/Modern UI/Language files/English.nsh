...
!insertmacro MUI_LANGUAGEFILE_BEGIN "ENGLISH"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_INNERTEXT_COMPONENTS "Check the components you want to install and uncheck the components you don't want to install."

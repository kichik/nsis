...
!insertmacro MUI_LANGUAGEFILE_BEGIN "RUSSIAN"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Если Вы принимаете условия соглашения, установите отметку в квадратике ниже. Вы должны принять условия соглашения для установки ${MUI_PRODUCT}. $_CLICK"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Если Вы принимаете условия соглашения, выберите первый вариант из имеющихся ниже. Вы должны принять условия соглашения для установки ${MUI_PRODUCT}. $_CLICK"  
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_CONFIRM_TITLE "Удаление ${MUI_PRODUCT}"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_CONFIRM_SUBTITLE "Удаление ${MUI_PRODUCT} с вашего компьютера."

  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_COMPONENTS_TITLE "Компоненты удаляемой программы"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_COMPONENTS_SUBTITLE "Выберите какие возможности ${MUI_PRODUCT} Вы хотите удалить."

...
!insertmacro MUI_LANGUAGEFILE_BEGIN "UKRAINIAN"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_WINDOWTITLE "${MUI_NAME} Установка"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_WINDOWTITLE "${MUI_NAME} Видалення"

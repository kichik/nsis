...
!define MUI_UKRAINIAN_USED
  ...
  !ifdef MUI_INSTALLBUTTONTEXT_NEXT
    InstallButtonText /LANG=${LANG_UKRAINIAN} "&Далi >"
  !endif
  ...
  !ifdef MUI_ABORTWARNING
    LangString MUI_MSGTEXT_ABORTWARNING ${LANG_UKRAINIAN} "Ви впевненнi що хочете покинути установку ${NAME}?"
  !endif
  
  !ifdef MUI_INSTALLOPTIONS
    LangString MUI_BUTTONTEXT_BACK ${LANG_UKRAINIAN} "< &Назад"
    LangString MUI_BUTTONTEXT_NEXT ${LANG_UKRAINIAN} "&Далi >"
    LangString MUI_BUTTONTEXT_CANCEL ${LANG_UKRAINIAN} "Скасувати"
    LangString MUI_BUTTONTEXT_INSTALL ${LANG_UKRAINIAN} "&Встановити"
  !endif
  ...
  !ifdef MUI_UNINSTALLOPTIONS
    LangString un.MUI_BUTTONTEXT_BACK ${LANG_UKRAINIAN} "< &Назад"
    LangString un.MUI_BUTTONTEXT_NEXT ${LANG_UKRAINIAN} "&Далi >"
    LangString un.MUI_BUTTONTEXT_CANCEL ${LANG_UKRAINIAN} "Скасувати"
    LangString un.MUI_BUTTONTEXT_UNINSTALL ${LANG_UKRAINIAN} "&Видалити"
  !endif  

...
!insertmacro MUI_LANGUAGEFILE_BEGIN "FINNISH"
  ...
  !define MUI_INNERTEXT_LICENSE_BOTTOM "Jos hyv‰ksyt ehdot, valitse Hyv‰ksyn jatkaaksesi. Sinun pit‰‰ hyv‰ksy‰ ehdot asentaaksesi ohjelman $(^Name)."
  !define MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Jos hyv‰ksyt ehdot, laita rasti alla olevaan ruutuun. Sinun pit‰‰ hyv‰ksy‰ ehdot asentaaksesi ohjelman $(^Name). $_CLICK"
  !define MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Jos hyv‰ksyt ehdot, valitse ensimm‰inen vaihtoehto alapuolelta. Sinun pit‰‰ hyv‰ksy‰ ehdot asentaaksesi ohjelman $(^Name). $_CLICK"
  ...
  !define MUI_TEXT_FINISH_INFO_TITLE "Viimeistell‰‰n ohjelman $(^Name) asennusta"
  !define MUI_TEXT_FINISH_INFO_TEXT "$(^Name) on asennettu koneellesi.\r\n\r\nValitse Valmis sulkeaksesi avustajan."
  !define MUI_TEXT_FINISH_INFO_REBOOT "Tietokoneesi pit‰‰ k‰ynnist‰‰ uudelleen jotta ohjelman $(^Name) asennus saataisiin valmiiksi. Haluatko k‰ynnist‰‰ koneen uudelleen nyt?"
  ...
  !define MUI_TEXT_FINISH_RUN "K‰ynnist‰ $(^Name)"

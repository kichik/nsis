...
!define MUI_GREEK_USED
  ...
  LangString MUI_TEXT_LICENSE_TITLE ${LANG_GREEK} "Συμφωνία Άδειας Χρήσης"  
  LangString MUI_TEXT_LICENSE_SUBTITLE ${LANG_GREEK} "Ελέγξτε τους όρους της άδειας χρήσης πριν εγκαταστήσετε το '${NAME}'."
  LangString MUI_INNERTEXT_LICENSE ${LANG_GREEK} "Για να συνεχιστεί η εγκατάσταση πρέπει να αποδεχθείτε όλους τους όρους της άδειας χρήσης. Αν τους αποδέχεστε, κάντε κλικ στο Συμφωνώ, αλλιώς κάντε κλικ στο Άκυρο για να τερματιστεί η εγκατάσταση."
  ...
  LangString MUI_BUTTONTEXT_CANCEL ${LANG_GREEK} "Άκυρο"
  ...
  LangString un.MUI_BUTTONTEXT_CANCEL ${LANG_GREEK} "Άκυρο"

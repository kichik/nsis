...
!insertmacro MUI_LANGUAGEFILE_BEGIN "Slovak"
  ...
  !define MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Ak súhlasíte s podmienkami zmluvy, zaškrtnite nišie uvedené políèko. Je nutné súhlasi s licenènou zmluvou, ak chcete pokraèova v inštalácii $(^NameDA)."
  !define MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Ak súhlasíte s podmienkami zmluvy, oznaète prvú z nišie uvedenıch moností. Je nutné súhlasi s licenènou zmluvou, ak chcete pokraèova v inštalácii $(^NameDA)."
  ...
  !define MUI_TEXT_INSTALLING_SUBTITLE "Èakajte prosím kım prebieha inštalácia $(^NameDA)."
  ...
  !define MUI_TEXT_FINISH_INFO_TEXT "$(^NameDA) bol nainštalovanı na Váš poèítaè.\r\nKliknite na Dokonèi pre uzavretie tohto sprievodcu."
  ...
  !define MUI_TEXT_STARTMENU_SUBTITLE "Zvo¾te poloku v ponuke Štart pre umiestnenie zástupcov $(^NameDA)."
  ...
  !define MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Ak súhlasíte s podmienkami zmluvy, zaškrtnite nišie uvedené políèko. Je nutné súhlasi s licenènou zmluvou, ak chcete pokraèova v odinštalovaní $(^NameDA). $_CLICK"
  !define MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Ak súhlasíte s podmienkami zmluvy, oznaète prvú z nišie uvedenıch moností. Je nutné súhlasi s licenènou zmluvou, ak chcete pokraèova v odinštalovaní $(^NameDA). $_CLICK"
  ...
  !define MUI_UNTEXT_UNINSTALLING_SUBTITLE "Èakajte prosím kım prebieha odinštalovanie $(^NameDA)."
  ...
  !define MUI_UNTEXT_FINISH_INFO_TEXT "$(^NameDA) bol odinštalovanı z Vášho poèítaèa.\r\n\r\nKliknite na Dokonèi pre uzavretie tohto sprievodcu."

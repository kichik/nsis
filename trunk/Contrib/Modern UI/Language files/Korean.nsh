...
!insertmacro MUI_LANGUAGEFILE_BEGIN "KOREAN"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_WELCOME_INFO_TITLE "${MUI_PRODUCT} 설치 마법사에 오신 것을 환영합니다."
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_WELCOME_INFO_TEXT "이 마법사는 당신의 컴퓨터에 ${MUI_PRODUCT}(을)를 설치할 것입니다.\r\n\r\n설치를 시작하기 전에 모든 프로그램을 종료해주시기 바랍니다. 프로그램을 종료하게 되면 시스템을 재부팅 하지 않고서도 특정한 시스템 파일을 수정할 수 있기 때문입니다.\r\n\r\n"

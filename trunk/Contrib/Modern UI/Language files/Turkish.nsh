...
!insertmacro MUI_LANGUAGEFILE_BEGIN "TURKISH"
  ...
  !define MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "Sözleþme koþullarýný kabul ediyorsanýz, aþaðýdaki check box'a basýnýz. $(^Name) programýný kurmak için sözleþme koþullarýný kabul etmelisiniz. $_CLICK"
  !define MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Sözleþme koþullarýný kabul ediyorsanýz, asagidaki ilk seçenegi seçiniz. $(^Name) programýný kurmak için sözleþme koþullarýný kabul etmelisiniz. $_CLICK"
  ...
  !define MUI_UNTEXT_LICENSE_SUBTITLE "Lütfen $(^Name) programini kaldýrmadan önce sözlesmeyi okuyunuz."
  !define MUI_UNINNERTEXT_LICENSE_BOTTOM "Sözleþme koþullarýný kabul ediyorsanýz, 'Kabul Ediyorum'a basýnýz. $(^Name) programýný kaldýrmak için sözleþme koþullarýný kabul etmelisiniz."
  !define MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Sözleþme koþullarýný kabul ediyorsanýz, aþaðýdaki check box'a basýnýz. $(^Name) programýný kaldýrmak için sözleþme koþullarýný kabul etmelisiniz. $_CLICK"
  !define MUI_UNINNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "Sözleþme koþullarýný kabul ediyorsanýz, asagidaki ilk seçenegi seçiniz. $(^Name) programýný kaldýrmak için sözleþme koþullarýný kabul etmelisiniz. $_CLICK"
  
  !define MUI_UNTEXT_COMPONENTS_TITLE "Paket Seçimi"
  !define MUI_UNTEXT_COMPONENTS_SUBTITLE "Lütfen $(^Name) için kaldýrmak istediginiz özellikleri seçiniz."
  
  !define MUI_UNTEXT_DIRECTORY_TITLE "Kaldýrlacak Hedef Seçimi"
  !define MUI_UNTEXT_DIRECTORY_SUBTITLE "$(^Name) programini kaldýrmak istediginiz dizini seçin."
  
  !define MUI_UNTEXT_UNINSTALLING_TITLE "Kaldýrýlýyor"
  !define MUI_UNTEXT_UNINSTALLING_SUBTITLE "$(^Name) kaldýrlýrken bekleyiniz."
    
  !define MUI_UNTEXT_FINISH_TITLE "Kaldýrma Tamamlandýr"
  !define MUI_UNTEXT_FINISH_SUBTITLE "Kaldýrma basariyla gerçeklesti."
  
  !define MUI_UNTEXT_ABORT_TITLE "Kaldýrma Iptal Edildi"
  !define MUI_UNTEXT_ABORT_SUBTITLE "Kaldýrma basariyla gerçeklestirilemedi."

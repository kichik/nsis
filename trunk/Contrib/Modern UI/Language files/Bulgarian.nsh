...
!insertmacro MUI_LANGUAGEFILE_BEGIN "BULGARIAN"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_WELCOME_INFO_TITLE "Добре дошли в инсталационния магьосник на ${MUI_PRODUCT}"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_WELCOME_INFO_TEXT "Той ще инсталира ${MUI_PRODUCT} на вашия компютър.\r\n\r\nПрепоръчва се да затворите всички други приложения, преди да стартирате инсталацията. Това ще позволи на инсталацията да обнови някои системни файлове, без да рестартира компютъра.\r\n\r\n"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_FINISH_INFO_TITLE "Завършване на магьосника за инсталация на ${MUI_PRODUCT}"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_FINISH_INFO_TEXT "${MUI_PRODUCT} е инсталиран на вашата система.\r\nНатиснете 'Приключи', за да затворите магьосника."
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_CONTINUE_UNINSTALL "Натиснете 'Деинсталиране', за да стартирате процеса на деинсталиране."
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_FINISH_TITLE "Приключи"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_UNTEXT_FINISH_SUBTITLE "Деинсталацията приключи успешно."

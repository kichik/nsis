...
!insertmacro MUI_LANGUAGEFILE_BEGIN "CATALAN"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_FINISH_INFO_TITLE "Finalitzant l'Assistent d'Instal·lació de $(^Name)"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_TEXT_FINISH_INFO_REBOOT "L'ordinador s'ha de reiniciar per que pugui completar-se la instal·lació de $(^Name). Desitja reiniciar-lo ara?"

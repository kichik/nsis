...
!insertmacro MUI_LANGUAGEFILE_BEGIN "TRADCHINESE"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_INNERTEXT_LICENSE_TOP "檢閱授權協議的其餘部分，請按 [PgDn] 往下捲動頁面。"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_INNERTEXT_LICENSE_BOTTOM "如果你同意所有合約中的條款，按一下 [我同意(I)] 繼續安裝。如果你選取 [取消(C)] ，安裝程式將會關閉。必須要接受授權協議才能安裝 ${MUI_PRODUCT} 。"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_INNERTEXT_LICENSE_BOTTOM_CHECKBOX "如果你接受授權協議中的條款，按一下下方的核取方塊。必須要接受授權協議才能安裝 ${MUI_PRODUCT}。"
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_INNERTEXT_LICENSE_BOTTOM_RADIOBUTTONS "如果你接受授權協議中的條款，選擇下方第一個選項。必須要接受授權協議才能安裝 ${MUI_PRODUCT}。"
  ...
  !insertmacro MUI_LANGUAGEFILE_STRING MUI_INNERTEXT_COMPONENTS_TOP "勾選想要安裝的元件，並把不想安裝的元件取消勾選。"

...
!insertmacro MUI_LANGUAGEFILE_BEGIN "THAI"
  ...
  !define MUI_TEXT_WELCOME_INFO_TITLE "ยินดีต้อนรับเข้าสู่การติดตั้งโปรแกรม $(^Name) "
  !define MUI_TEXT_WELCOME_INFO_TEXT "ตัวติดตั้งนี้จะติดตั้งโปรแกรม $(^Name) ลงบนคอมพิวเตอร์ของคุณ\r\n\r\nทางเราขอแนะนำให้ปิดโปรแกรมอื่นๆให้หมดก่อนที่จะเริ่มติดตั้ง และตัวติดตั้งนี้ไม่ต้องการการรีบูตเครื่องใหม่\r\n\r\n$_CLICK"
  
  !define MUI_TEXT_LICENSE_TITLE "ข้อตกลงเรื่องลิขสิทธิ์"  
  !define MUI_TEXT_LICENSE_SUBTITLE "กรุณาอ่านข้อตกลงด้านลิขสิทธิ์ก่อนติดตั้งโปรแกรม $(^Name)."
  !define MUI_INNERTEXT_LICENSE_TOP "กดปุ่ม Page Down เพื่ออ่านรายละเอียดที่เหลือ"
  !define MUI_INNERTEXT_LICENSE_BOTTOM "ถ้าคุณยอมรับในข้อตกลงนี้ กรุณากดปุ่ม ยอมรับ และคุณจะต้องตกลงก่อนที่จะเริ่มติดตั้งโปรแกรม $(^Name)."
  
  !define MUI_TEXT_COMPONENTS_TITLE "เลือกคอมโพเนนต์"
  !define MUI_TEXT_COMPONENTS_SUBTITLE "เลือก features ของ $(^Name) ที่คุณต้องการติดตั้ง"
  ...
  !define MUI_TEXT_DIRECTORY_SUBTITLE "เลือกโฟลเดอร์ที่ต้องการให้ติดตั้งลง $(^Name)."
  !define MUI_INNERTEXT_DIRECTORY_TOP "กำลังที่จะติดตั้งโปรแกรม $(^Name) ลงในโฟลเดอร์ด้านล่างนี้$\r$\n$\r$\nหากคุณต้องการให้ติดตั้งลงโฟลเดอร์อื่นกรุณาคลิ๊กปุ่มเรียกหาแล้วเลือกโฟลเดอร์ที่ต้องการ"
  !define MUI_INNERTEXT_DIRECTORY_DESTINATION "โฟลเดอร์จุดหมาย"
  
  !define MUI_TEXT_INSTALLING_TITLE "กำลังติดตั้ง"
  !define MUI_TEXT_INSTALLING_SUBTITLE "กรุณารอสักครู่ระหว่างโปรแกรม $(^Name) กำลังติดตั้งอยู่"
  ...
  !define MUI_TEXT_FINISH_INFO_TITLE "กำลังดำเนินการเรียกโปรแกรมติดตั้ง $(^Name) "
  !define MUI_TEXT_FINISH_INFO_TEXT "$(^Name) ถูกติดตั้งเรียบร้อยแล้ว\r\n\r\nคลิ๊กปุ่ม เสร็จสิ้น เพื่อออกจากโปรแกรม"
  !define MUI_TEXT_FINISH_INFO_REBOOT "เครื่องของคุณต้องการการรีบูตหลังจากติดตั้ง $(^Name). คุณต้องการที่จะรีบูตเลยหรือไม่"
  !define MUI_TEXT_FINISH_REBOOTNOW "รีบูต"
  !define MUI_TEXT_FINISH_REBOOTLATER "รีบูตทีหลัง"
  !define MUI_TEXT_FINISH_RUN "เปิดโปรแกรม $(^Name)"
  ...
  !define MUI_UNTEXT_CONFIRM_TITLE "ลบโปรแกรม $(^Name) ออกจากเครื่อง"
  !define MUI_UNTEXT_CONFIRM_SUBTITLE "ลบโปรแกรม $(^Name) ออกจากเครื่องของคุณ"
  
  !define MUI_UNTEXT_UNINSTALLING_TITLE "กำลังลบ"
  !define MUI_UNTEXT_UNINSTALLING_SUBTITLE "กรุณารอขณะที่ $(^Name) กำลังถูกลบ"
